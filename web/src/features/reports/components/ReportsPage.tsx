...
import { formatDay } from '@/lib/format/formatDay';
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm tabular-nums text-fg-muted">
        ...
        {formatTimestamp(summary.generated_at)} · Period {formatDay(summary.period.from)} →{' '}
        {formatDay(summary.period.to)}
      </p>
...
export const ReportsPage = () => {
  ...
  if (summaryQuery.isPending) {
    ...
    content = (
      <>
        <SummaryView summary={summaryQuery.data} groupBy={groupBy} />
        {/* The drill-down behind the analytics: every decision of the
            period, clickable through to its full record. */}
        <DecisionDrilldown params={params} />
      </>
    );
  }
